         ...
         <div  className="section__advantages">
                    <div className="container">
                        ...
                        <div className="advantages__rows">
                            ...
                            <img src={`${process.env.PUBLIC_URL}/images/Board.png`} alt="" />
                            ...
                            <div style={{display: 'flex'}}>
                            <img src={`${process.env.PUBLIC_URL}/images/Package.png`} alt="" />
                            <div className="advantages__info-row">
                            ...
                            <div style={{display: 'flex'}}>
                            <img style={{marginRight: '6px'}} src={`${process.env.PUBLIC_URL}/images/Delivery.png`} alt="" />
                            <div className="advantages__info-row">
                            ...
                            <img src={`${process.env.PUBLIC_URL}/images/BestSupport.png`} alt="" />
                            <div className="advantages__info-row">
                            ...
                            <div style={{display: 'flex'}}>
                            <img src={`${process.env.PUBLIC_URL}/images/ClearInfo.png`} alt="" />
                            <div className="advantages__info-row">
                            ...
                            <div style={{display: 'flex'}}>
                            <img src={`${process.env.PUBLIC_URL}/images/Garantee.png`} alt="" />
                            <div className="advantages__info-row">
